...
from configurations.config import (
    ...
    LORA_R, LORA_ALPHA, LORA_TARGET_MODULES, LORA_DROPOUT, LORA_BIAS, LORA_TASK_TYPE, TRAINING_ARGS
)
...
lora_config = get_lora_config(
    r=LORA_R, alpha=LORA_ALPHA, target_modules=LORA_TARGET_MODULES, 
    dropout=LORA_DROPOUT, bias=LORA_BIAS, task_type=LORA_TASK_TYPE
)
